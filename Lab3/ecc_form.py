...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        # Kết nối các nút bấm với tên tương ứng trong file ui.ecc
    ...
    def call_api_sign(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                # Dùng setPlainText vì txt_si là QPlainTextEdit
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if (data["is_verified"]):
                    ...
                    msg = QMessageBox()
                    msg.setIcon(QMessageBox.Warning) # Nên để Warning khi verify thất bại
